...
NS_LOG_COMPONENT_DEFINE ("DialupLink");
...
main (int argc, char *argv[])
{
  ...
  NodeContainer DialupLink;

  DialupLink.Create (8);
  Names::Add ( "N1", DialupLink.Get (0));
  Names::Add ( "N2", DialupLink.Get (1));
  Names::Add ( "N3", DialupLink.Get (2));
  Names::Add ( "R1", DialupLink.Get (3));
  Names::Add ( "R2", DialupLink.Get (4));
  Names::Add ( "N4", DialupLink.Get (5));
  Names::Add ( "N5", DialupLink.Get (6));
  Names::Add ( "N6", DialupLink.Get (7));


  N1R1 = NodeContainer (DialupLink.Get (0), DialupLink.Get (3));
  N2R1 = NodeContainer (DialupLink.Get (1), DialupLink.Get (3));
  N3R1 = NodeContainer (DialupLink.Get (2), DialupLink.Get (3));
  R1R2 = NodeContainer (DialupLink.Get (3), DialupLink.Get (4));
  R2N4 = NodeContainer (DialupLink.Get (4), DialupLink.Get (5));
  R2N5 = NodeContainer (DialupLink.Get (4), DialupLink.Get (6));
  R2N6 = NodeContainer (DialupLink.Get (4), DialupLink.Get (7));

  NS_LOG_INFO ("Install internet stack on all nodes.");
  InternetStackHelper internet;
  internet.Install (DialupLink);
  ...
  tchBottleneck.SetRootQueueDisc ("ns3::PfifoFastQueueDisc", "Limit", UintegerValue (8));
  ...
  ApplicationContainer serverApps = echoServer.Install (DialupLink.Get (5));
  ...
  ApplicationContainer clientApps = echoClient.Install (DialupLink.Get (0));
