...
NS_LOG_COMPONENT_DEFINE ("DelayTradeOff");
...
main (int argc, char *argv[])
{
  ...
  NodeContainer DelayTradeOff;

  DelayTradeOff.Create (8);
  Names::Add ( "N1", DelayTradeOff.Get (0));
  Names::Add ( "N2", DelayTradeOff.Get (1));
  Names::Add ( "N3", DelayTradeOff.Get (2));
  Names::Add ( "R1", DelayTradeOff.Get (3));
  Names::Add ( "R2", DelayTradeOff.Get (4));
  Names::Add ( "N4", DelayTradeOff.Get (5));
  Names::Add ( "N5", DelayTradeOff.Get (6));
  Names::Add ( "N6", DelayTradeOff.Get (7));


  N1R1 = NodeContainer (DelayTradeOff.Get (0), DelayTradeOff.Get (3));
  N2R1 = NodeContainer (DelayTradeOff.Get (1), DelayTradeOff.Get (3));
  N3R1 = NodeContainer (DelayTradeOff.Get (2), DelayTradeOff.Get (3));
  R1R2 = NodeContainer (DelayTradeOff.Get (3), DelayTradeOff.Get (4));
  R2N4 = NodeContainer (DelayTradeOff.Get (4), DelayTradeOff.Get (5));
  R2N5 = NodeContainer (DelayTradeOff.Get (4), DelayTradeOff.Get (6));
  R2N6 = NodeContainer (DelayTradeOff.Get (4), DelayTradeOff.Get (7));

  NS_LOG_INFO ("Install internet stack on all nodes.");
  InternetStackHelper internet;
  internet.Install (DelayTradeOff);

  // Setting the channel properties

  NS_LOG_INFO ("Create channels");
  //Config::SetDefault ("ns3::PfifoFastQueueDisc::Limit", UintegerValue (0));
  ...
  ApplicationContainer serverApps = echoServer.Install (DelayTradeOff.Get (5));
  ...
  ApplicationContainer clientApps = echoClient.Install (DelayTradeOff.Get (0));
