...
NS_LOG_COMPONENT_DEFINE ("DialupLinkTcpVariants");
...
main (int argc, char *argv[])
{
  ...
  // Select TCP variant       Use lookup by name
...

    {
      ...
      fileName = "DialupLink"+transport_prot[i]+".txt";
      ...
      Ptr<Node> Traffic_source = DialupLink.Get (0);
      Ptr<Node> Traffic_sink = DialupLink.Get (7);
