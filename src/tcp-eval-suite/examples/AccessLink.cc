...
NS_LOG_COMPONENT_DEFINE ("AccessLink");
...
main (int argc, char *argv[])
{
  ...
  NodeContainer AccessLink;

  AccessLink.Create (8);
  Names::Add ( "N1", AccessLink.Get (0));
  Names::Add ( "N2", AccessLink.Get (1));
  Names::Add ( "N3", AccessLink.Get (2));
  Names::Add ( "R1", AccessLink.Get (3));
  Names::Add ( "R2", AccessLink.Get (4));
  Names::Add ( "N4", AccessLink.Get (5));
  Names::Add ( "N5", AccessLink.Get (6));
  Names::Add ( "N6", AccessLink.Get (7));


  N1R1 = NodeContainer (AccessLink.Get (0), AccessLink.Get (3));
  N2R1 = NodeContainer (AccessLink.Get (1), AccessLink.Get (3));
  N3R1 = NodeContainer (AccessLink.Get (2), AccessLink.Get (3));
  R1R2 = NodeContainer (AccessLink.Get (3), AccessLink.Get (4));
  R2N4 = NodeContainer (AccessLink.Get (4), AccessLink.Get (5));
  R2N5 = NodeContainer (AccessLink.Get (4), AccessLink.Get (6));
  R2N6 = NodeContainer (AccessLink.Get (4), AccessLink.Get (7));

  NS_LOG_INFO ("Install internet stack on all nodes.");
  InternetStackHelper internet;
  internet.Install (AccessLink);
  ...
  ApplicationContainer serverApps = echoServer.Install (AccessLink.Get (5));
  ...
  ApplicationContainer clientApps = echoClient.Install (AccessLink.Get (0));
