...
public:
   ...
   */
  EvalStats (uint32_t bandwidth, Time rttp, std::string fileName, Ptr<QueueDisc> queue);
   ...
   *
   */
  void AggregateQueue (Ptr<const QueueItem> packet);
  ...
  /**
    ...
    *
    */
  void Install (Ptr<NetDevice> node, Ptr<TrafficParameters> traffic);
